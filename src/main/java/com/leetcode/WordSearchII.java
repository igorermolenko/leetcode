...
public class WordSearchII {
    ...
    public List<String> findWords(char[][] board, String[] words) {
        ...
        for (int i = 0; i < board.length; i++) {
            for (int j = 0; j < board[0].length; j++) {
                addWords(board, i, j, root, result);
            }
        }
    ...
    private void addWords(char[][] board, int row, int col, Trie node, Set<String> words) {
        ...
        addWords(board, row + 1, col, nextNode, words);
        addWords(board, row - 1, col, nextNode, words);
        addWords(board, row, col + 1, nextNode, words);
        addWords(board, row, col - 1, nextNode, words);
    ...
    public static void main(String[] args) {
        ...
        WordSearchII task = new WordSearchII();
        ...
        System.out.println(task.findWords(new char[][]{{'a', 'b'}, {'c', 'd'}}, new String[]{"abdc"}));
